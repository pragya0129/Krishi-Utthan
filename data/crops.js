export const crops = [
  {
    Barley: {
      ...
      description:
        "Barley is a cereal grain that is a staple food in many parts of the world.",
      season: "Winter",
  ...
  },
  {
    Maize: {
      ...
      description:
        "Maize, also known as corn, is a staple food in many parts of the world.",
      season: "Summer",
  ...
  },
  {
    Peas: {
      ...
      description:
        "Peas are a type of legume, known for their small round green seeds.",
      season: "Spring",
  ...
  },
  {
    Radish: {
      ...
      climate:
        "Radishes prefer cooler temperatures and can be grown in spring and fall.",
      season: "Spring",
  ...
  },
  {
    Spinach: {
      ...
      climate:
        "Spinach thrives in cool weather and can be grown in both spring and fall.",
      season: "Spring",
...

  {
    Tomato: {
      ...
      climate:
        "Tomatoes thrive in warm weather and are typically grown in the summer.",
      season: "Summer",
  ...
  },
  {
    Wheat: {
      ...
      description:
        "Wheat is a cereal grain that is a staple food in many parts of the world for making flour.",
      season: "Winter",
  ...
  },
  {
    Rice: {
      ...
      climate:
        "Rice requires a lot of water and is typically grown in flooded fields.",
      season: "Monsoon",
  ...
  },
  {
    Cruciferous: {
      ...
      climate:
        "Cruciferous vegetables thrive in cool weather and can tolerate some frost.",
      season: "Monsoon",
  ...
  },
  {
    Millet: {
      ...
      climate:
        "Millet is grown in a variety of climates, from tropical to temperate.",
      season: "Winter",
  ...
  },
  {
    Coconut: {
      ...
      climate:
        "Coconut palms thrive in warm, tropical climates with plenty of sunlight and rainfall.",
      season: "All-year",
  ...
  },
  {
    Rubber: {
      ...
      climate:
        "Rubber trees thrive in warm, tropical climates with high rainfall.",
      season: "All-year",
  ...
  },
  {
    Tea: {
      ...
      climate:
        "Tea is grown in regions with warm temperatures, high humidity, and consistent rainfall.",
      season: "All-year",
